    ...
    <body class="transparencia fondo2 ">
        <div class="container">
            ...
            <div class="container">
                ...
                <div class="row">
                    <form class="form-horizontal" id="limpiar2">
                        <div class="form-group">
                            <label for="id" class="col-sm-2 control-label tipof">Id Producto</label>
                            <div class="col-sm-5">
                                <input type="number" class="form-control" id="id_producto" name="id_producto" placeholder="Id Producto" required>
            ...
            <div class="row">
                <div class="form-group col-md-5 col-md-offset-5">              
                    <a href="consulta_producto.php" class="btn btn-primary btn-group-center tipof">Ir a Consulta</a>
                </div> 
            </div>
            <div class="container">
                <footer class="footer">
